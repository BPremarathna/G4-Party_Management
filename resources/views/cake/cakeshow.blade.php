...
<body>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('cakeinput') }}"> Create New Cake</a>
            </div>
            <br>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>{{ $cake->unitPrice }}</td>
            <td><img src="/images/{{ $cake->cakeImage }}" width="100px"></td>
            <td>{{ $cake->suppliers_id }}</td>
