...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/birthstyle.css')}}">
...
<body>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <img class="engageimage" src="images/b2.jpg" alt="main-image" width="100%" height="50%">
              <div class="caption">
                <h1><b>BIRTHDAY PARTIES</b></h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
             <div class="col-lg-6 col-sm-6 col-md-6">
                  <h2 class="heading-1"><b>Birthday Parties</h2></b>
                  <img src="images/b3.jpg" class="birthday-image2" height="400px">
              </div>
              <div class="col-lg-6 col-sm-6 col-md-6">
                  <p class="sec-details-3">A birthday party is much more than a simple blowing out of candles. It is a combination of delicious food, good music and of course, good times! We are dedicated in making your birthday a memorable one by delivering a personalized experience.
                  </p>
                  <img src="images/b6.jpg" class="birthday-image3" width="468px" height="207px">
              </div>
          </div>
        </div>
    </div>

    <div class="birthday-details1">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-md-6">
            <img src="images/b5.jpg" class="birthday-image4" height="380px" width="570px">
          </div>
          <div class="col-lg-6 col-sm-6 col-md-6">
    ...
    <div class="birthday-details2">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 col-md-6">
            <img src="images/b4.jpg" class="birthday-image5" height="380px" width="570px">
          </div>
          <div class="col-lg-6 col-sm-6 col-md-6">
            <img src="images/b7.jpg" class="birthday-image6" height="379" width="540px">
          </div>
        </div>
      </div>
    </div>
